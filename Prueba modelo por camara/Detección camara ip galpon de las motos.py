...
cap = cv2.VideoCapture('rtsp://contralor:Villegas555@192.168.103.149/cgi-bin/main.cgi') #variable con la direccion de la camara
w=int(cap.get(3)/2)
h=int(cap.get(4)/2)
...
while(True):
    ...
    cv2.imshow('Camera galpon de las motos',img)  #muestra la camara ip
