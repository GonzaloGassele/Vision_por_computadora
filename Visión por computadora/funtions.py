...
def active_cam():
    ...
    cap[0][1]=CamGear(source='rtsp://contralor:Villegas555@192.168.103.149/cgi-bin/main.cgi').start()# Galpon motos
    cap[1][1]=CamGear(source='rtsp://contralor:Villegas555@100.100.34.179/cgi-bin/main.cgi').start()# Polo lateral
    cap[2][1]=CamGear(source='rtsp://contralor:Villegas555@100.100.34.183/cgi-bin/main.cgi').start()# Atras del polo
    cap[3][1]=CamGear(source='rtsp://contralor:Villegas555@100.100.34.184/cgi-bin/main.cgi').start()# Polo frente
    cap[4][1]=CamGear(source='rtsp://contralor:Villegas555@192.168.103.233/cgi-bin/main.cgi').start()# Estacionamiento emision
    cap[5][1]=CamGear(source='rtsp://contralor:Villegas555@192.168.103.234/cgi-bin/main.cgi').start()# Baños
    cap[6][1]=CamGear(source='rtsp://contralor:Villegas555@192.168.102.105/cgi-bin/main.cgi').start()# Entrada de pacheco
    cap[7][1]=CamGear(source='rtsp://contralor:Villegas555@192.168.102.98/cgi-bin/main.cgi').start()# Entrada de pacheco 2
